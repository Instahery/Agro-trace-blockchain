...
🚀 Added
    ...
    Otomatisasi Database (Trigger): Menambahkan skema trigger before_insert_climate_date_fix pada tabel climate_daily untuk pengisian kolom week_id dan year_id secara otomatis pada setiap data baru.🔧 Fixed / Optimized
